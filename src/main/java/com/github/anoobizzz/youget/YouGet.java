package com.github.anoobizzz.youget;

import com.github.anoobizzz.youget.domain.AbstractRequest;
import com.github.anoobizzz.youget.domain.Client;
import com.github.anoobizzz.youget.domain.DownloadHandler;
import com.github.anoobizzz.youget.domain.Notifier;
import com.github.anoobizzz.youget.exception.InitializationException;
import com.github.anoobizzz.youget.info.ParserResolver;
import com.github.anoobizzz.youget.info.StreamDownloadInfo;
import com.github.anoobizzz.youget.stock.StockClient;
...
public class YouGet {
    ...
    public YouGet() throws InitializationException {
        this(4, System.getProperty("user.dir") + "/downloads", new StockClient(4));
    }

    public YouGet(int parallelism) throws InitializationException {
        this(parallelism, System.getProperty("user.dir") + "/downloads", new StockClient(parallelism));
    }

    public YouGet(String targetDir) throws InitializationException {
        this(4, targetDir, new StockClient(4));
    }

    public YouGet(int parallelism, String targetDir) throws InitializationException {
        this(parallelism, targetDir, new StockClient(parallelism));
    }

    public YouGet(int parallelism, String path, Client client) throws InitializationException {
        ...
        if (!targetDir.exists() && !targetDir.mkdir()) {
            throw new InitializationException("Failed to create instance of YouGet downloader: directory " +
                    targetDir.getAbsolutePath() + " doesn't exist and can't be created!");
        }
    }
