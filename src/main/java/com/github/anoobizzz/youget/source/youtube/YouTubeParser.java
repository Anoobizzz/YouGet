...
import com.github.anoobizzz.youget.domain.ContentComparator;
import com.github.anoobizzz.youget.domain.Notifier;
import com.github.anoobizzz.youget.domain.VideoContent;
import com.github.anoobizzz.youget.domain.stream.StreamAudio;
import com.github.anoobizzz.youget.domain.stream.StreamCombined;
import com.github.anoobizzz.youget.domain.stream.StreamInfo;
import com.github.anoobizzz.youget.exception.AgeRestrictionException;
import com.github.anoobizzz.youget.exception.DownloadException;
import com.github.anoobizzz.youget.exception.EmbeddingDisabledException;
import com.github.anoobizzz.youget.exception.EmptyTitleException;
import com.github.anoobizzz.youget.exception.UnavailablePlayerException;
import com.github.anoobizzz.youget.exception.VideoDeletedException;
import com.github.anoobizzz.youget.info.StreamDownloadInfo;
import com.github.anoobizzz.youget.info.YouGetParser;
...
import static com.github.anoobizzz.youget.domain.DownloadHandler.getHtml;
import static com.github.anoobizzz.youget.domain.stream.Quality.getQualityByITag;
...
public class YouTubeParser extends YouGetParser {
    ...
    private List<VideoContent> extractContent(URL link, YouTubeInfo info, Notifier notifier) {
        try {
            ...
            return extractHtmlInfo(info, getHtml(link));
    ...
    private List<VideoContent> extractEmbedded(YouTubeInfo info, URL link)
        ...
        Map<String, String> map = getQueryMap(
                getHtml(new URL(String.format("https://www.youtube.com/get_video_info?authuser=0&video_id=%s&el=embedded", id))));
